...
public class DialogPlusBuilder {
    ...
    private boolean shouldRequestFocus = true;
    ...
    /**
     * Define if the dialog should request focus when attached
     */
    public DialogPlusBuilder setShouldRequestFocus(boolean shouldRequestFocus) {
